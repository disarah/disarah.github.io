...
/* harmony import */ var _components_tags__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/tags */ "./src/components/tags.js");
/* harmony import */ var _components_image_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/image.css */ "./src/components/image.css");
/* harmony import */ var _components_image_css__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_image_css__WEBPACK_IMPORTED_MODULE_6__);
...
const Tags = ({
  ...
  const {
    edges
  } = data.allMarkdownRemark; // can also include totalCount

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_4__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, tag), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_tags__WEBPACK_IMPORTED_MODULE_5__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    const {
      slug
    } = node.fields; //const { title , featuredImage, featuredImageAlt} = node.frontmatter
...
Tags.propTypes = {
  pageContext: prop_types__WEBPACK_IMPORTED_MODULE_1___default().shape({
  ...
  data: prop_types__WEBPACK_IMPORTED_MODULE_1___default().shape({
    allMarkdownRemark: prop_types__WEBPACK_IMPORTED_MODULE_1___default().shape({
      totalCount: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number.isRequired),
      edges: prop_types__WEBPACK_IMPORTED_MODULE_1___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default().shape({
        node: prop_types__WEBPACK_IMPORTED_MODULE_1___default().shape({
